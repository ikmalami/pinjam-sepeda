...
<div class="banner-bg banner-bg1">	
	<div class="container">
		<div class="header">
		  	...
		  	<div class="top-nav">										 
			    ...
			    <ul class="nav">
					...
					<li class="dropdown1"><a>HALO, <?php echo $email?></a>
					</li> 
			  	</ul>
		 	</div>
	 ...
	 <div class="dwn">
		<a class="scroll" href="#cate"><img src="<?php echo base_url('assets/img/scroll.png') ?>" alt=""/></a>
	 </div>				 
</div>
<!--/banner-->
<!--bikes-->
...
<div class="footer">
	 <div class="container wrap">
		<div class="logo2">
			 <a href="index.html"><img src="<?php echo base_url('assets/img/logo2.png') ?>" alt=""/></a>
		</div>
		<div class="ftr-menu">
			 <ul>
